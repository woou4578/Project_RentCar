...
<?php
    ...
    if(array_key_exists('firstBtn2',$_POST)) {movePage("previousRental.php");}
    if(array_key_exists('secondBtn1',$_POST)) {movePage("reserve.php");}
    if(array_key_exists('secondBtn2',$_POST)) {movePage("cancelReservation.php");}
    if(array_key_exists('secondBtn3',$_POST)) {movePage("returnCar.php");}
?>